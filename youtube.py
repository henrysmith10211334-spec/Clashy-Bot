...
# Highest quality first — for brand new uploads (especially via near-instant
...
def setup_youtube(bot):
    """
    Wires up the new-video webhook + backup poll + live-stream poll onto
    the given bot. Returns (start_tasks, build_web_app) for bot.py to call.
    """
    ...
    return start_tasks, build_web_app
